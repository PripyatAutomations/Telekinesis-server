...
my $radio = 'radio0';
my $ua_dir = "/opt/netrig/run/baresip-$radio";
...
print $config_fh "# Edit /opt/netrig/etc/netrig.yaml instead!\n";
print $config_fh <<EOF;
...
print $launch_fh "# Edit /opt/netrig/etc/netrig.yaml instead!\n";
...
print $ast_users_fh "; Edit /opt/netrig/etc/netrig.yaml instead!\n";
...
print $ast_dialplan_fh "; Edit /opt/netrig/etc/netrig.yaml instead!\n";
print $ast_dialplan_fh "[$radio]\n";
print $ast_dialplan_fh "exten => 0,1,NoOp()\n";
print $ast_dialplan_fh " same => n,Set(VOLUME(TX)=4)\n";
print $ast_dialplan_fh " same => n,Stasis(netrig,$radio);\n";
